...
<Note>
  Deposits use the real Solana USDC mint `EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v`; acquire USDC from any Solana DEX (Jupiter, Raydium, Orca) or transfer from a centralized exchange. 15 active markets trade 24/7. Read the [risk disclosure](/reference/risks) before trading.
</Note>
