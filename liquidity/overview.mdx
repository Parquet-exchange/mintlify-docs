...
<Note>
  The public LP **farm** (`/farm`) is **live on mainnet** — deposit USDC into a
  market's pool to become a liquidity provider and earn the LP cut of trading
  fees. A few markets are not yet open for deposits (pools with an active payout
  queue); the rest accept deposits now.
</Note>
