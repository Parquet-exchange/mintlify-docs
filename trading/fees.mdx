...
| Funding rate cap | **300% APR** (≈0.82% / day) — bounded; protocol ceiling 10 bps/hour |
...
- The funding rate is **capped at 300% APR** (≈0.82% per day) — the binding limit enforced on-chain (the protocol's absolute ceiling is 10 bps/hour, which funding never reaches in practice).
